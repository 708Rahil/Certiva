    ...
    <div style={{ maxWidth: 800, margin: '60px auto 100px', padding: '0 24px', color: 'var(--text-primary)' }}>
      ...
      <section style={{ marginBottom: 32 }}>
        ...
        <p style={{ color: 'var(--text-secondary)', lineHeight: 1.6, fontSize: 15 }}>
          By accessing or using Certiva, you agree to comply with and be bound by these Terms of Service. If you do not agree, please do not use our platform.
        </p>
      </section>
      ...
      <section style={{ marginBottom: 32 }}>
        ...
        <p style={{ color: 'var(--text-secondary)', lineHeight: 1.6, fontSize: 15 }}>
          Certiva provides certification roadmaps and recommendations for informational purposes only. We make no guarantees regarding job placement, career advancement, or correctness of external certification costs/details.
        </p>
      </section>
    </div>
  );
